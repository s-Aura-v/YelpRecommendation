...
public class InformationRetrieval {
    public static void main(String[] args) {
        ...
        int index = 0;
        try {
            buffRead = new BufferedReader(new FileReader("C:/Users/slamich2/Documents/GitHub/YelpRecommendation/src/main/java/jsonBusinessTest.json"));
        ...
        for (int i = 0; i < businessData.length; i++) {
            String name = String.join(" ", String.valueOf(businessData[i].get("name")).split("\\P{Alnum}+"));
            ...
            hashtable.add(new Business(name,id));
        ...
        index = 0;
        try {
            buffRead = new BufferedReader(new FileReader("C:/Users/slamich2/Documents/GitHub/YelpRecommendation/src/main/java/jsonReviewTest.json"));
            while (index < businessData.length) {
                String line = buffRead.readLine();
        ...
        for (int i = 0; i < businessReview.length; i++) {
            ...
            String review = String.join(" ", String.valueOf(businessReview[i].get("text")).split("\\P{Alnum}+"));
//            for ()
        }
